...
- The root and server lockfiles changed only for the reviewed MFA dependencies and their transitive packages. The post-change frontend and backend audits both report zero known vulnerabilities. Unrelated framework upgrades remain deferred to a separately tested maintenance update.
